...
func TestReturnStatements(t *testing.T) {
	...
	for _, stmt := range program.Statements {
		...
		if !ok {
			t.Errorf("stmt not *st.ReturnStatement. got=%T", stmt)
			continue
		}
...
func TestIdentifierExpression(t *testing.T) {
	...
	if ident.TokenLiteral() != "foobar" {
		t.Errorf("ident.TokenLiteral not %s. gott=%s", "foobar", ident.TokenLiteral())
	}
}
...
func TestParsingPrefixExpressions(t *testing.T) {
	...
	for _, tt := range prefixTests {
		...
		if len(program.Statements) != 1 {
			t.Fatalf("program.Statements does not contain %d sttements. got=%d\n", 1, len(program.Statements))
		}
		...
		if !ok {
			t.Fatalf("stmt is not ast.PrefixExppression. got=%T", stmt.Expression)
		}
...
func testIdentifier(t *testing.T, exp ast.Expression, value string) bool {
	...
	if ident.TokenLiteral() != value {
		t.Errorf("ident.TokenLiterl not %s. got=%s", value, ident.TokenLiteral())
		return false
	}
	return true
}
...
func TestFunctionLiteralParsing(t *testing.T) {
	...
	if len(program.Statements) != 1 {
		t.Fatalf("program.Statements[0] does not contain %d statemets. got=%d\n", 1, len(program.Statements))
	}
...
func TestParsingHasgLiteralStringKeys(t *testing.T) {
